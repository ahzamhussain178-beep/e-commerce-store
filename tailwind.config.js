  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'brand-lg': '0 8px 16px -4px rgba(0, 0, 0, 0.1), 0 4px 8px -2px rgba(0, 0, 0, 0.06)',
        'brand-xl': '0 16px 32px -8px rgba(0, 0, 0, 0.15), 0 8px 16px -4px rgba(0, 0, 0, 0.1)',
        'brand-red': '0 4px 20px rgba(230, 57, 70, 0.15)',
      },
      animation: {
